...
public class Task15Test {
    ...
    void task1() {
        ...
        answer.put(Animal.Type.DOG, 267);
        answer.put(Animal.Type.CAT, 153);
        answer.put(Animal.Type.BIRD, 28);
        answer.put(Animal.Type.FISH, 12);
        answer.put(Animal.Type.SPIDER, 3);

        assertThat(answer).isEqualTo(Task15.task15(animals, 0, 1000));
    }
    @Test
    @DisplayName("Проверка суммарного веса с границами")
    void task2() {
        List<Animal> animals = new ArrayList<>();
        Animal dog1 = new Animal("Sharik", Animal.Type.DOG, Animal.Sex.M, 7, 60, 55, false);
        Animal dog2 = new Animal("Bobik", Animal.Type.DOG, Animal.Sex.M, 5, 50, 77, false);
